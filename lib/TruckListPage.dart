                ...
                return StreamBuilder<Map<String, bool>>(
                  ...
                  builder: (context, liveSnapshot) {
                    ...
                    return FutureBuilder(
                      future: Future.wait(companies.map((company) => company.reference.collection('trucks').get()).toList()),
                      builder: (context, AsyncSnapshot<List<QuerySnapshot>> truckSnapshots) {
                        if (!truckSnapshots.hasData) {
                          return Center(child: CircularProgressIndicator());
                        }
                        ...
                        for (var i = 0; i < companies.length; i++) {
                          ...
                          var trucks = truckSnapshots.data![i].docs;
                        ...
                        if (searchQuery.isNotEmpty) {
                          allTrucks = allTrucks.where((entry) {
                            var truckName = (entry['truck'].data() as Map<String, dynamic>)['name'].toString().toLowerCase();
                        ...
                        allTrucks.sort((a, b) {
                          var nameA = (a['truck'].data() as Map<String, dynamic>)['name'].toString().toLowerCase();
                          var nameB = (b['truck'].data() as Map<String, dynamic>)['name'].toString().toLowerCase();
                          return selectedSortOption == 'ABC'
